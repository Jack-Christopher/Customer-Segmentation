...
emails = pd.read_csv('https://raw.githubusercontent.com/LuisSante/Datasets/main/names.csv')
address = list(emails['Email Address'])
contact_names = list(emails['FirstName LastName'])

#correos = ["rsantisteban@unsa.edu.pe", "jhuaihuah@unsa.edu.pe", "lsantet@unsa.edu.pe"]
priority = ["0","1","2","3"]
stage_id = ["1","2","3","4"]
partner_id = ["7","4","8","9"]
partner_name = ["Ejemplo","Propuestas2", "Ejemplo2", "Propuestas"]
...
for i in range(i, 2000):
	...
	contact_names_chose = random.choice(contact_names)
